    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-50 flex items-center justify-center p-6">
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 style={{ fontFamily: "Fraunces, serif" }} className="text-3xl text-slate-800 font-semibold">Welcome back</h1>
          <p className="text-slate-400 mt-1">Sign in to your EduGenAI account</p>
        </div>
        ...
        <div className="card p-8 shadow-xl shadow-indigo-100/50">
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPw ? "text" : "password"} value={password} onChange={e => setPassword(e.target.value)}
                  placeholder="Your password" className="input-base pr-12" required />
          ...
          <p className="text-center text-sm text-slate-500 mt-6">
            ...
            <Link to="/signup" className="text-indigo-600 font-bold hover:text-indigo-700">Sign up free</Link>
          </p>
        </div>
      </motion.div>
    </div>
